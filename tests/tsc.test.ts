...
const TSC_COMMONJS_PATH = path.resolve(__dirname, '../dist/.js');
const TSC_COMMONJS_SOURCEMAP_PATH = path.resolve(__dirname, '../dist/.js.map');

describe('tsc bundle result', () => {
  test('should generate .js and .js.map for commonjs modules', (done) => {
