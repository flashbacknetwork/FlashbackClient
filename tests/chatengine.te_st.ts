...
*/
  test('should maintain conversation context across multiple turns using vector memory', async () => {
    ...
    try {
      ...
      const prompt1 =
        "I'm planning to build a mobile app for tracking fitness activities. I prefer React Native because I know JavaScript well, and I want the app to work on both iOS and Android.";
      ...
      const prompt2 =
        'What database would you recommend for storing workout history and user progress data?';
      ...
      const prompt4 =
        'Based on what I mentioned earlier about my technology preferences and JavaScript knowledge, should I use TypeScript or stick with plain JavaScript for this fitness app?';
